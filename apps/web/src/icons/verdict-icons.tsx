 ...
 *
 *  22 ta ikonka, 23 ta kodga bog'langan.
 */
...
/** Phosphor `bug` (MIT). */
export const VerdictIconBug = (p: IconProps) => (
...
export const VerdictIconChartPie = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconCheckCircle = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconClockCountdown = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconCloudSlash = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `cpu` (MIT). */
export const VerdictIconCpu = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `gauge` (MIT). */
export const VerdictIconGauge = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `gear` (MIT). */
export const VerdictIconGear = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconHourglass = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `moon` (MIT). */
export const VerdictIconMoon = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconProhibit = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconQuestion = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `ruler` (MIT). */
export const VerdictIconRuler = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconShieldWarning = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconSkipForward = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconSpinnerGap = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconTestTube = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `timer` (MIT). */
export const VerdictIconTimer = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconUploadSimple = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconWarningOctagon = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
/** Phosphor `wrench` (MIT). */
export const VerdictIconWrench = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VerdictIconXCircle = (p: IconProps) => (
  <svg {...base} className={p.className ?? "size-5"} aria-hidden="true">
...
export const VERDICT_ICONS: Record<string, (p: IconProps) => React.JSX.Element> = {
  PENDING: VerdictIconHourglass,
  RUNNING: VerdictIconSpinnerGap,
  AC: VerdictIconCheckCircle,
  WA: VerdictIconXCircle,
  TLE: VerdictIconTimer,
  MLE: VerdictIconCpu,
  OLE: VerdictIconUploadSimple,
  RE: VerdictIconWarningOctagon,
  RE_SIGNAL: VerdictIconWarningOctagon,
  RE_EXIT: VerdictIconWarningOctagon,
  CE: VerdictIconWrench,
  PE: VerdictIconRuler,
  PARTIAL: VerdictIconChartPie,
  IE: VerdictIconGear,
  WRONG_TEST: VerdictIconTestTube,
  SKIPPED: VerdictIconSkipForward,
  COMPILE_TIMEOUT: VerdictIconClockCountdown,
  IDLENESS: VerdictIconMoon,
  SECURITY_VIOLATION: VerdictIconShieldWarning,
  CHECKER_ERROR: VerdictIconBug,
  TESTING_ABORTED: VerdictIconProhibit,
  RATE_LIMITED: VerdictIconGauge,
  DENIAL_OF_JUDGEMENT: VerdictIconCloudSlash,
};
