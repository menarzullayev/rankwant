...
| 2026-09-18 | [ci-hosted-public](2026-09-18-ci-hosted-public/REPORT.md) | Public repo standard Actions ni $0 qiladi, 4 vCPU; larger runner pullik; HITL — hook ni toraytirish, repo yopiq | `.githooks/pre-push` |
